...
function AddPhieuNhapXuat(props) {
							...
							<Grid container spacing={2} item xs={12} sm={12}>
								...
								<Grid item xs={12} sm={6}>
									<Typography variant="subtitle1" >
										Thời gian tạo: {dayjs(getValues("ngayLap_Phieu")).format(FORMAT_YYYY_MM_DD)}
									</Typography>
								</Grid>
								<Grid item xs={12} sm={6}>
									<Typography variant="subtitle1">
										Tạo bởi: {getValues("nguoiDeXuat")}
									</Typography>
								</Grid>
							</Grid>
...
export default connect(mapStateToProps)(AddPhieuNhapXuat);