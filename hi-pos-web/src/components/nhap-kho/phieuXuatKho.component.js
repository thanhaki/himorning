...
import AddPhieuXuat from './addPhieuXuatKho.component';
...
function PhieuXuatKho(props) {
	...
	const handleDelete = () => {
		...
		if (listCheck.length > 0) {
			showMessageByType(null, "Phiếu đã xuất/hủy kho không thể xóa", TYPE_ERROR.warning)
		}
		else {
	...
	return (
		<ThemeProvider theme={theme}>
			<Container component="main" maxWidth="true">
				...
				{open && <AddPhieuXuat open={open} title={"THÊM MỚI PHIẾU XUẤT KHO"} handleClose={handleClose} handleLoadPageParent={handleLoadPage} />}
				{openEdit && <AddPhieuXuat open={openEdit} title={nameTitle} nameRow={nameRow} handleClose={handleCloseEdit} handleLoadPageParent={handleLoadPageEdit} />}
				<AlertDialogMessage
					open={openDelete}
...
export default connect(mapStateToProps)(PhieuXuatKho);