...
function IntroductionHRAM(props) {
    ...
    const [introductionSteps, setIntroductionSteps] = useState([
        {
            idC: 1,
            label: 'Tạo danh mục chi',
            description: `Ví dụ :`,
            warning: '',
            examples: ['Chi điện', 'Chi nước', 'Chi mặt bằng', 'Chi lương ... '],
            steps: [{
                ids: 'a',
                label: 'Menu',
                itemNo: 0
            ...
            route: '/danhmuc-thuchi',
        },
        {
            idC: 2,
            label: 'Tạo danh mục thu',
            description:
                'Ví dụ :',
            warning: '',
            examples: ['Thu tiền doanh thu hàng ngày', 'Thu tiền tip', 'Thu tiền đền hàng bể vỡ, mất mát, ... '],
            steps: [{
                ids: 'a',
                label: 'Menu',
                itemNo: 0
        ...
        {
            idC: 3,
            label: 'Tạo đối tượng thu chi',
            description: `Ví dụ:`,
            warning: 'Loại khách hàng: đối tác',
            examples: ['Viettel,VNPT', 'Anh Toàn chủ mặt bằng', 'Family mart', 'Nhà cung cấp Mạnh Toàn', 'Nhân viên', 'Khách hàng'],
            steps: [{
                ids: 'a',
                label: 'Menu',
                itemNo: 0
        ...
        },
        {
            ...
            label: 'Tạo phiếu thu',
            description: `Ví dụ :`,
            warning: 'Có check: Hoạch toán kinh doanh',
            examples: ['Tạo phiếu thu doanh thu tiền mặt'],
            steps: [{
                ids: 'a',
                label: 'Menu',
                itemNo: 0
                ...
                ids: 'e',
                label: 'Check Hoạch Toán Kinh Doanh',
                itemNo: 2000
            }],
            route: '/phieuthu',
        },
        {
            ...
            description: `Ví dụ :`,
            warning: 'Có check: Hoạch toán kinh doanh',
            examples: ['Tạo phiếu chi lương tháng 07/2023'],
            steps: [{
                ids: 'a',
                label: 'Menu',
                itemNo: 0
    ...
    useEffect(() => {
        ...
        TableService.getResultGetResultCheckGuideToRevenueAndExpenditure(data).then((result) => {
            dispatch(hideLoading());
                    ...
                    <Stepper nonLinear activeStep={activeStep} orientation="vertical">
                        {introductionSteps.map((step, index) => (
                            <Step key={step.label} completed={completed[index]}>
                                ...
                                <StepContent>
                                    {step.warning !== '' ? <Typography sx={{ pl: 1, pb: 1, pt: 1, color: 'red' }}>{step.warning}</Typography> : ''}
                                                        ...
                                                        <Step key={stepChild.label}>
                                                            <Grid item xs={12} sm={12} md={12} lg={12} key={indexChild}>
                                                                {indexChild === 0 ? (
                                                                    ...
                                                                    (indexChild === 1 && index === 2) ? (
                                                                        < StepLabel sx={{ justifyContent: 'center' }} StepIconComponent={ManageAccountsIcon}>
                                                                            <Typography sx={{ fontSize: 15, fontWeight: 'Bold' }}>
                                                                                Bước {indexChild + 1} : Chọn -{'>'} {stepChild.label}
                                                                            </Typography>
                                                                        </StepLabel>
                                                                    ) : (
                                                                        (indexChild === 1 && (index === 0 || index === 1 || index === 3 || index === 4)) ? (
                                                                            < StepLabel sx={{ justifyContent: 'center' }} StepIconComponent={PaidIcon}>
                                                                                <Typography sx={{ fontSize: 15, fontWeight: 'Bold' }}>
                                                                                    Bước {indexChild + 1} : Chọn -{'>'} {stepChild.label}
                                                                                </Typography>
                                                                            </StepLabel>
