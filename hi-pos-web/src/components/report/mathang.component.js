...
import MatHangBanChay from "./mathang/banchay.component";
import MatHangDaHuy from "./mathang/dahuy.component";
import DanhMucMatHang from "./mathang/danhmuc.component";
...
const BaoCaoMatHang = (props) => {
    ...
    const renderBaoCao = () => {
        switch (baoCaoCurrent) {
            case 1:
                return <DanhMucMatHang loaiBaoCao={baoCaoCurrent}/>
            case 2:
                return <MatHangBanChay loaiBaoCao={baoCaoCurrent}/>
            case 3:
                return <MatHangDaHuy loaiBaoCao={baoCaoCurrent}/>
        }
    }
...
export default connect(mapStateToProps)(BaoCaoMatHang);