...
namespace Pos.API.Common
{
    public static class Utilities
    {
        ...
        public static decimal ToFixed(this decimal number, uint decimals)
        {
            return decimal.Parse(number.ToString("N" + decimals));
        }
        public static DateTime RemoveSecond(this DateTime date)
        {
            var val = date.AddSeconds(-date.Second);
            val = val.AddMilliseconds(-date.Millisecond);
            val = val.AddMicroseconds(-date.Microsecond);
            return val;
        }
    }
}
